                    ...
                    <form className='flex-1 flex flex-col'>
                        <div className='flex flex-1 flex-col gap-3 p-5'>
                            ...
                            {shouldShowOnboarding ? (
                                <p className='text-sm leading-6 text-slate-400'>
                                    Comece <button type="button" className='font-medium text-lime-400' onClick={handleStartRecording}> gravando </button> uma nota em audio ou se preferir <button className='font-medium text-lime-400' onClick={handleStartEditor} type='button'> utilize apenas texto</button>
                                </p>
                            ) : (
                                <textarea
                                    autoFocus
